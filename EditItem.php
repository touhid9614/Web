							...
							<div class="dropdown">
			       			<button onclick=myFunction2() class="dropbtn">Men's fashion</button>
			        			<div id="myDropdown2" class="dropdown-content">
									<a href="UCausalTshirt.php">Casual Shirt</a>
									<a href="UJeansPants.php">Jeans Pants</a>
									<a href="UFormalShirt.php">Formal Shirts</a>
									<a href="UFormalPant.php">Formal Pants</a>
									<a href="UWatch.php">Watch</a>
									<a href="UFootwear.php">Footwear</a>
									<a href="USportProduct.php">Sports Outfit</a>
								</div>
							</div>
						</td>
